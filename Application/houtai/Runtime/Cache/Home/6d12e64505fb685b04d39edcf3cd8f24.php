...
<li>
								<a href="<?php echo U('guanggao/guanggao');?>">
									<o class="font12 rigbg">广告列表</o>
								</a>

								<b class="arrow"></b>
							</li><li>
								<a href="<?php echo U('guanggao/xggg');?>">
									<o class="font12 ">修改广告</o>
								</a>
...
<tbody>
<?php if(is_array($ggsj)): foreach($ggsj as $k=>$v): ?><tr>
<td align="center">
<label class="pos-rel">
...
<td><?php echo ($v["ggmc"]); ?></td>
<td><img src="/dianyingfbb/Public<?php echo ($v["ggtp"]); ?>"></td>
<td><?php echo ($v["url"]); ?></td>
<td><?php echo (date("m月d日 H:s:d",$v["cjsj"])); ?></td>
<td>
<div class="hidden-sm hidden-xs action-buttons">
<a class="green" href="<?php echo U('guanggao/xggg',array(id=>$v['id']));?>" title="修改">
