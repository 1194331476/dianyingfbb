...
<li>
			...
			<a href="<?php echo U('wenzhang/tjxw');?>">
...
<div class="col-xs-12">
    ...
    <form id="leftnav" name="leftnav" method="post" action="http://localhost/index.php/Admin/News/leftnavorder.html">
		<table id="dynamic-table" class="table table-striped table-bordered table-hover">
            ...
            <?php if(is_array($xwlb)): foreach($xwlb as $k=>$v): ?><tr>
				    <td><?php echo ($k+1); ?></td>
					<td><?php echo ($v["leibie"]["lbmc"]); ?></td>
					<td><?php echo ($v["biaoti"]); ?></td>
					<td><?php echo ($v["zhuyan"]); ?></td>
					<td><?php echo ($v["diqu"]["lbmc"]); ?></td>					
					<td><?php echo (date('Y-m-d H:m:s',$v["cjsj"])); ?></td>
					<td><?php echo ($v["llcs"]); ?></td>
					<td>
						<div class="hidden-sm hidden-xs action-buttons">
						<a class="blue" href="<?php echo U('wenzhang/zfl',array(id=>$v['id']));?>" title="子分类">
							<i class="ace-icon fa fa-plus-circle bigger-130"></i>		
						</a>
						<a class="green" href="<?php echo U('wenzhang/xgxw',array(id=>$v['id']));?>" title="修改">
              ...
              <tr>
				  ...
				  <td colspan="7"><?php echo ($fenye); ?></td>
			  </tr>
			</tbody>
		</table>
      </form>
