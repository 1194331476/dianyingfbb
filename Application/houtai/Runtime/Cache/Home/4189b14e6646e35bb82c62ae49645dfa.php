...
<li>
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal" name="form" id="form0" method="post" action="<?php echo U('wenzhang/clxgxw');?>" enctype="multipart/form-data">
				 <div class="form-group">
		            ...
		            <select name="djid"  class="col-sm-3 selector">
		           		 <option value="<?php echo ($xgsj["djid"]["id"]); ?>"><?php echo ($xgsj["djid"]["lbmc"]); ?></option>
		           		 <?php if(is_array($flsj)): foreach($flsj as $key=>$v): if($v['level'] == 0): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["lbmc"]); ?></option><?php endif; endforeach; endif; ?>                         
		         </select>
		            </div>
		            </div>
		            ...
		            <select name="pid"  class="col-sm-3 selector">
		           		 <option value="<?php echo ($xgsj["leibie"]["id"]); ?>"><?php echo ($xgsj["leibie"]["lbmc"]); ?></option>
		           		 <?php if(is_array($flsj)): foreach($flsj as $key=>$v): if($v['level'] == 1): if($v['diqu'] == 0): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["lbmc"]); ?></option><?php endif; endif; endforeach; endif; ?>                         
		           </select>
		            </div>
		            </div>
					<div class="space-4"></div>
                	...
                	<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="biaoti" id="news_title" value="<?php echo ($xgsj["biaoti"]); ?>" class="col-xs-10 col-sm-6">
							</span>
						</div>
					</div>
                    <div class="space-4"></div>
				  ...
				  <div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="zhuyan" id="news_title" value="<?php echo ($xgsj["zhuyan"]); ?>" class="col-xs-10 col-sm-6">
							</span>
						</div>
					</div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" name="sysj" id="news_title" value="<?php echo ($xgsj["sysj"]); ?>" class="col-xs-10 col-sm-6">
							</span>
						</div>
					</div>
                    <div class="space-4"></div>
 				<div class="form-group">
		            ...
		            <option value="<?php echo ($xgsj["diqu"]["id"]); ?>"><?php echo ($xgsj["diqu"]["lbmc"]); ?></option>
		             <?php if(is_array($flsj)): foreach($flsj as $key=>$v): if($v['diqu'] == 1): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["lbmc"]); ?></option><?php endif; endforeach; endif; ?>                        
		         </select>
		            </div>
		            </div>
					<div class="space-4"></div>
				...
				<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right" for="form-field-1">文章封面上传： </label>
				<div class="col-sm-9">
				<a href="javascript:;" class="file">
                  <input type="file" name="fengmian" id="file0" value="<?php echo ($xgsj["wzfm"]); ?>">
					选择上传文件
				</a>
				</div>
				</div>
					...
					<div class="form-group">
						...
						<textarea name="neirong" id="neirong" cols="30" rows="10"><?php echo ($xgsj["neirong"]); ?></textarea>
					</div>
                    <div class="space-4"></div>
                    <input type="hidden" name="dqid" value="<?php echo ($xgsj["id"]); ?>">
