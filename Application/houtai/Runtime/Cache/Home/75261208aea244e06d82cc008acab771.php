...
<li>
						<a href="<?php echo U('yqlj/ljgl');?>">
							<o class="font12 ">友情链接列表</o>
						</a>

						<b class="arrow"></b>
					</li><li>
						<a href="<?php echo U('yqlj/tjlj');?>">
							<o class="font12 rigbg">添加链接</o>
						</a>
...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" name="columnadd" id="columnadd" method="post" action="<?php echo U('yqlj/cltjlj');?>" enctype="multipart/form-data">
        	...
        	<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="ljmc" id="column_name" placeholder="必填：网址名称" class="col-xs-10 col-sm-5">
             ...
             <div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 链接URL: </label>
				<div class="col-sm-9">
					<input type="text" name="url" id="column_name" placeholder="必填：http://形式" class="col-xs-10 col-sm-5">
                    <span class="help-inline col-xs-12 col-sm-7">
						<span class="middle" id="resone"></span>
					</span>
				</div>
