...
<li>
						<a href="<?php echo U('guanggao/guanggao');?>">
							<o class="font12 ">广告列表</o>
						</a>

						<b class="arrow"></b>
					</li><li>
						<a href="./网站后台系统管理_files/网站后台系统管理.html">
							<o class="font12 rigbg">修改广告</o>
						</a>
...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" name="columnadd" id="columnadd" method="post" action="<?php echo U('guanggao/clxggg');?>" enctype="multipart/form-data">
        <div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 广告所属分类： </label>
			<div class="col-sm-9">
            <select name="pid"  class="col-sm-3 selector">
            	 <option><?php echo ($dqsj["fenlei"]); ?></option>              
         </select>
            </div>
            </div>
        	...
        	<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="ggmc" id="column_name" placeholder="必填：广告名称" class="col-xs-10 col-sm-5" value="<?php echo ($dqsj["ggmc"]); ?>">
			...
			<div class="form-group">
				...
				<img src="/dianyingfbb/Public<?php echo ($dqsj["ggtp"]); ?>" class="col-sm-1">
				<div class="col-sm-8">
				<a href="javascript:;" class="file">
                  <input type="file" name="tpsc" id="file0">
					选择上传文件
				</a>
				</div>
				</div>
             <div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 广告URL: </label>
				<div class="col-sm-9">
					<input type="text" name="url" id="column_name" placeholder="必填：广告名称" class="col-xs-10 col-sm-5" value="<?php echo ($dqsj["url"]); ?>">
                    <span class="help-inline col-xs-12 col-sm-7">
						<span class="middle" id="resone"></span>
					</span>
				</div>
			</div>
			<input type="hidden" name="dqid" value="<?php echo ($dqsj["id"]); ?>">
