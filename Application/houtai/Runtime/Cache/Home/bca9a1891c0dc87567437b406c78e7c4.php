...
<li>
						<a href="<?php echo U('wzlb/wzlb');?>">
							<o class="font12 ">类别列表</o>
						</a>

						<b class="arrow"></b>
					</li><li>
						<a href="./网站后台系统管理_files/网站后台系统管理.html">
							<o class="font12 rigbg">添加类别</o>
						</a>
...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" name="columnadd" id="columnadd" method="post" action="<?php echo U('wzlb/cltj');?>">
        

        	<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 类别名称: </label>
				<div class="col-sm-9">
					<input type="text" name="lbmc" id="column_name" placeholder="必填：栏目名称" class="col-xs-10 col-sm-5">
            ...
            <div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 文章属性：  </label>
								<div class="checkbox">
                                <label id="news_flag_c">
										<input class="ace ace-checkbox-2" name="level" type="checkbox" id="news_flag_vac" value="1">
            ...
            <div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 文章属性：  </label>
								<div class="checkbox">
                                <label id="news_flag_c">
										<input class="ace ace-checkbox-2" name="diqu" type="checkbox" id="news_flag_vac" value="1">
